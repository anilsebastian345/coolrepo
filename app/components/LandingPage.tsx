        ...
        <div className="max-w-[560px] mx-auto text-center space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-4">
            <button
              ...
              className="w-full md:w-72 py-3 px-6 bg-white border border-gray-200 rounded-full text-[#222222] font-medium flex items-center justify-center gap-3 shadow-sm hover:shadow-md transition-all duration-200 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#7C9151]"
              type="button"
            >
            ...
            <button
              ...
              className="w-full md:w-72 py-3 px-6 bg-transparent border-2 border-[#7C9151] rounded-full text-[#7C9151] font-medium hover:bg-[#7C9151] hover:text-white transition-all duration-200 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#7C9151]"
              type="button"
            >
              Continue as Guest
            </button>
      ...
      <section className="py-20 px-4">
        <div className="max-w-[640px] mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button
              onClick={handleGoogleSignIn}
              className="w-full sm:w-auto px-8 py-3 bg-[#7C9151] text-white font-medium rounded-full hover:bg-[#6B7E45] transition-all duration-200 shadow-sm hover:shadow-md focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#7C9151]"
              type="button"
            >
              Get Started Today
            </button>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6">
              <a
                href="#about"
                className="text-sm text-[#4A4A4A] hover:text-[#7C9151] transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#7C9151] rounded"
              >
                About
              </a>
              <a
